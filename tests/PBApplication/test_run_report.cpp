...
TEST_CASE("Decoder report preserves verified progress and final acceptance independently", "[application][report][decoder]")
{
    ...
    snapshot.remoteMetricSamples = 145800;
    snapshot.remoteZeroMagnitudeMetrics = 7290;
    ...
    REQUIRE(json.find("\"remoteMetricTelemetry\":{\"frames\":9,\"samples\":145800,\"zeroMagnitudeMetrics\":7290") != std::string::npos);
